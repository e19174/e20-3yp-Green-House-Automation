...
public class SensorDataService {
    ...
    public void getDataFromAWS(byte[] data) throws DeviceNotFoundException {
        ...
        SensorData sensorData = SensorData.builder()
                ...
                .soilMoisture( awsData.get("humidity") != null ? awsData.get("moisture") instanceof Integer ? Double.valueOf((Integer) awsData.get("moisture"))
                        : (Double) awsData.get("moisture"): 0)
                .temperature( awsData.get("humidity") != null ? awsData.get("temperature") instanceof Integer ? Double.valueOf((Integer) awsData.get("temperature"))
                        : (Double) awsData.get("temperature"): 0)
                .nitrogenLevel( awsData.get("humidity") != null ? awsData.get("nitrogenLevel") instanceof Integer ? Double.valueOf((Integer) awsData.get("nitrogenLevel"))
                        : (Double) awsData.get("nitrogenLevel"): 0)
                .phosphorusLevel( awsData.get("humidity") != null ? awsData.get("phosphorusLevel") instanceof Integer ? Double.valueOf((Integer) awsData.get("phosphorusLevel"))
                        : (Double) awsData.get("phosphorusLevel"): 0)
                .potassiumLevel( awsData.get("humidity") != null ? awsData.get("potassiumLevel") instanceof Integer ? Double.valueOf((Integer) awsData.get("potassiumLevel"))
